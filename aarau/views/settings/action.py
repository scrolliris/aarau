...
@view_config(route_name='settings',
             renderer=tpl('account.mako', resource='settings'))
@view_config(route_name='settings.section',
...
@view_config(route_name='settings.section',
             ...
             renderer=tpl('email.mako', resource='settings'))
@login_required
...
@view_config(route_name='settings.email_activate',
             request_method='GET')
@login_required
...
@view_config(route_name='settings.section',
             ...
             request_method=('GET', 'POST'),
             renderer=tpl('password.mako', resource='settings'))
@login_required
