          ...
          <div class="attached box">
            <form id="change_password" class="form${' error' if err_msg else ' success' if suc_msg else ''}" action="${req.route_url('settings.section', section='password', subdomain='')}" method="post">
              ...
              <div class="row">
                ...
                <div class="required field-10 field-n-16${' error' if form.new_password.errors else ''}">
                  <label class="label" for="new_password">New password</label>
                  ${form.new_password(class_='', autocomplete='new-password')}
                  ${render_error_message(form.new_password)}
                </div>

                <div class="required field-10 field-n-16${' error' if form.new_password_confirmation.errors else ''}">
