...
<form id="${ctx}_application_site" class="form${' error' if err is not None else ''}" action="${act}" method="post">
  ...
  <div class="row">
    <div class="required field-8 field-v-12 field-l-16${' error' if f.domain.errors else ''}">
  ...
  <div class="row">
    <div class="optional field-8 field-v-12 field-l-16${' error' if _f.description.errors else ''}">
      ...
      ${_f.description(class_='', rows=2, cols=30, placeholder='Science notes from my daily thoughts.')}
