...
def test_publication_site_new_get_missing_project(users, dummy_request):
    ...
    with pytest.raises(HTTPNotFound):
        publication_site_new(dummy_request)
...
# GET publication_site_edit

def test_publication_site_edit_get_missing_project(users, dummy_request):
    from aarau.views.console.site.publication.action import \
        publication_site_edit
    ...
    with pytest.raises(HTTPNotFound):
        publication_site_edit(dummy_request)


def test_publication_site_edit_get_missing_site(mocker, users, dummy_request):
    from aarau.views.console.site.publication.action import \
        publication_site_edit
...
def test_publication_site_edit_get(mocker, users, dummy_request):
...
# POST publication_site_edit

def test_publication_site_edit_post_missing_project(users, dummy_request):
    from aarau.views.console.site.publication.action import \
        publication_site_edit
...
def test_publication_site_edit_post_missing_site(users, dummy_request):
    from aarau.views.console.site.publication.action import \
        publication_site_edit
...
def test_publication_site_edit_post_with_validation_error(
        users, dummy_request):
    from aarau.views.console.site.form import build_edit_publication_site_form
    from aarau.views.console.site.publication.action import \
        publication_site_edit
...
def test_publication_site_edit_post(mocker, users, dummy_request):
    from aarau.views.console.site.publication.action import \
        publication_site_edit
