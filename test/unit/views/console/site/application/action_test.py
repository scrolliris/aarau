...
def test_application_site_script_without_type(users, dummy_request):
    from pyramid.httpexceptions import HTTPNotFound
...
def test_application_site_script_missing_project(users, dummy_request):
    from webob.multidict import MultiDict
    from pyramid.httpexceptions import HTTPNotFound
...
def test_application_site_script_missing_site(users, dummy_request):
    from webob.multidict import MultiDict
    from pyramid.httpexceptions import HTTPNotFound
